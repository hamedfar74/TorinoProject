...
const Featurs = () => {
  return (
    <div className={styles.container}>
        <div>
            <Image width={65} height={65} src="/icons/best-price.svg" alt="icon" />
            <span>
        ...
        <div>
            <Image width={65} height={65} src="/icons/message.svg" alt="icon" />
            <span>
                <h4>پشتیبانی</h4>
        ...
        <div>
            <Image width={65} height={65} src="/icons/endors.svg" alt="icon" />
            <span>
                <h4>رضایت کاربران</h4>
